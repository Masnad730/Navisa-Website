...
export default function Home() {
  return (
    <Layout
      title='درباره ما - دارالترجمه نویسا'
      canonical='https://navisa.af/fa/about/'
      descriptionContent='.دارالترجمه نویسا یک شرکت خدماتی واقع در افغانستان بوده که عمدتاً در ساحه ترجمه، محلی سازی وب سایت، رونویسی و تصحیح فعالیت دارد'
      jsonLD='{
        ...
        "@graph": [
          ...
          {
            "@type": "WebPage",
            "@id": "https://navisa.af/fa/about/#webpage",
            "url": "https://navisa.af/fa/about/",
            "name": "در باره ما",
            "description": ".دارالترجمه نویسا یک شرکت خدماتی واقع در افغانستان بوده که عمدتاً در ساحه ترجمه، محلی سازی وب سایت، رونویسی و تصحیح فعالیت دارد",
            "inLanguage": "fa-AF",
      ...
      <div className='bg-accents_0'>
        <div className='container'>
          <div className='row py-12 md:py-16 lg:py-20'>
                    ...
                    <div className='row justify-center'>
                      <div className='col-md-4'>
                        <div className='bg-accents_2 w-24 h-24 flex items-center justify-center rounded-full mx-auto mt-0 mb-7'>
                          <img src='/images/flags/afghanistan.png' alt='پشتو/دری' />
                        </div>
                      </div>
                      <div className='col-md-4'>
                        <div className='bg-accents_2 w-24 h-24 flex items-center justify-center rounded-full mx-auto mt-0 mb-7'>
            ...
            <div className='col-xl-6 col-lg-6'>
              <div className='text-right mb-12 lg:mb-0'>
                <Fade up>
            ...
            <div className='col-md-4'>
              <Fade left>
                <div className='mb-12 lg:mb-0'>
                  <img src='/images/industry.jpg' alt='ساحات تحت پوشش خدمات نویسا' />
                </div>
              </Fade>
            </div>
