const ServicesFeatures = () => {
  return (
    <div className='py-8'>
      <h3 className='text-lg sm:text-xl lg:text-2xl mb-4'>Our Best Features</h3>
        ...
        <div className='row'>
          <div className='col-md-6 overflow-hidden'>
            <div className='relative border-t border-accents_2 p-4 mb-8'>
              ...
              <p className='leading-6 text-paragraph'>
          ...
          <div className='col-md-6 overflow-hidden'>
            <div className='relative border-t border-accents_2 p-4 mb-8'>
              ...
              <p className='leading-6 text-paragraph'>
                Don’t worry! We won’t make you wait for your translations any longer than is
