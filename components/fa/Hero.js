          ...
          <div className='row'>
            <div className='col-md-8 offset-md-4 text-left'>
              <div className='text-white text-right'>
                <Fade left>
                  <div className='flex items-center justify-end xs:mb-2 mb-4 lg:mb-6'>
                ...
                <Fade up>
                  <div>
                    <h1 className='text-3xl sm:text-5xl lg:text-6xl text-white leading-tight mb-3 lg:mb-6'>
                      خدمات مسلکی ترجمه
                    </h1>
                  </div>

                  <div className='text-accents_4 mb-3 lg:mb-6'>
